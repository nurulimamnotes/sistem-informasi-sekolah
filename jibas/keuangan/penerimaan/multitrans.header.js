...
AcceptSearch = function(data, noid, nama) {
	$("#kelompok").val(data);
	$("#noid").val(noid);
	$("#nama").val(nama);
...
StartPayment = function()
{
	...
	var addr = "multitrans.content.php?departemen="+departemen+"&idtahunbuku="+idtahunbuku+"&kelompok="+kelompok+"&noid="+noid+"&nama="+nama;
