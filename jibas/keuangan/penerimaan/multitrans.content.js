...
AddToPaymentListWjb = function()
{
	...
	*/
	...
	if (jcicilan < jdiskon)
	{
		alert("Jumlah cicilan harus lebih besar daripada jumlah diskon!");
	...
	{
		alert("Pembayaran cicilan tidak boleh lebih besar daripada sisa tagihan!");
	...
	var infocicil = "Pembayaran cicilan ke-" + ncicil + " " + $("#payment option:selected").text();
	if (jcicilan - jdiskon == sisa)
