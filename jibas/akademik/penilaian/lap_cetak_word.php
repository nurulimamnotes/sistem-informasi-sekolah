...
<table width="100%" border="0">
  ...
  <tr>
	...
	<tr>
		<td width="18%" rowspan="2" bgcolor="#CCCCCC"><div align="center"><strong>Pelajaran</strong></div></td>
...
<?		for($i = 0; $i < count($aspekarr); $i++)
	...
	<tr>
<?	for($i = 0; $i < count($aspekarr); $i++)
		echo "<td class='header' align='center' width='7%' bgcolor='#CCCCCC'><strong>Angka</strong></td>
			  <td class='header' align='center' width='7%' bgcolor='#CCCCCC'><strong>Huruf</strong></td>
			  <td class='header' align='center' width='20%' bgcolor='#CCCCCC'><strong>Terbilang</strong></td>"; ?>   
   </tr>
